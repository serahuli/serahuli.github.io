...
![image-20200925161441259](HTTP:1.0 和 HTTP:1.1 支持的方法.png)
...
- 没有 **Cookie** 信息状态下的请求
  ...
  ![image-20200925173525411](没有 **Cookie** 信息状态下的请求.png)

- 第 **2** 次以后（存有 **Cookie** 信息状态）的请求 

  ![image-20200925173555179](第 2 次以后（存有 Cookie 信息状态）的请求.png)
